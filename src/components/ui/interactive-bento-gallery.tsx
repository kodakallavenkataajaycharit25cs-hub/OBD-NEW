        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 auto-rows-[60px] md:auto-rows-[100px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-2 sm:p-3 md:p-4">
                                        ...
                                        <h3 className="relative text-white text-xs sm:text-sm md:text-base font-medium line-clamp-1 drop-shadow-md">
                                            {item.title}
                                        </h3>
                                        <p className="relative text-white/90 text-[10px] sm:text-xs md:text-sm mt-0.5 line-clamp-2 drop-shadow-md">
                                            {item.desc}
                                        </p>
                                    </div>
                                </motion.div>
