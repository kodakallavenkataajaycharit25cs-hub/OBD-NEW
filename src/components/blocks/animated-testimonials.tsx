    ...
    <section ref={sectionRef} id="testimonials" className={`py-24 overflow-hidden bg-transparent ${className || ""}`}>
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        ...
        >
            ...
            <div className="space-y-6">
              {badgeText && (
                <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-500/10 text-blue-400">
                  <Star className="mr-1 h-3.5 w-3.5 fill-blue-400" />
                  <span>{badgeText}</span>
                </div>
              )}
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`h-2.5 rounded-full transition-all duration-300 ${
                      activeIndex === index ? "w-10 bg-blue-500" : "w-2.5 bg-gray-600"
                    }`}
          ...
          <motion.div variants={itemVariants} className="relative h-full mr-10 min-h-[400px] md:min-h-[500px]">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="bg-[#120F17] border border-white/10 shadow-lg rounded-xl p-8 h-full flex flex-col">
                  ...
                  <div className="relative mb-6 flex-1">
                    ...
                    <p className="relative z-10 text-lg font-medium leading-relaxed text-gray-300">"{testimonial.content}"</p>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <Avatar className="h-12 w-12 border border-white/20">
                      ...
                      <AvatarFallback className="bg-blue-900 text-blue-100">{testimonial.name.charAt(0)}</AvatarFallback>
                    </Avatar>
                    <div>
